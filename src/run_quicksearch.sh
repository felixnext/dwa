...
# final items
python3 run.py --name="final-base" --experiment=mixture --approach=dwa --weight_init="kaiming:xavier" --nepochs=200 --delta=1.0 --alpha=1.0 --gate=tanh --lamb_reg=500 --lamb_loss=[10,0.1] --seed=0 --log_path="../res"
python3 run.py --name="final-warm" --experiment=mixture --approach=dwa --weight_init="kaiming:xavier" --nepochs=200 --delta=1.0 --alpha=1.0 --gate=tanh --lamb_reg=500 --lamb_loss=[10,0.1] --warmup=[20,1000] --seed=0 --log_path="../res"
python3 run.py --name="final-stif" --experiment=mixture --approach=dwa --weight_init="kaiming:xavier" --nepochs=200 --delta=1.0 --alpha=1.0 --gate=tanh --lamb_reg=500 --lamb_loss=[10,0.1] --stiff=200 --seed=0 --log_path="../res"