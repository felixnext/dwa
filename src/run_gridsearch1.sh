...
python3 run.py --name="lam1-01" --experiment=mixture --approach=dwa --weight_init="kaiming:xavier" --lamb_loss=[1,0.1] --seed=0
python3 run.py --name="lam01-001" --experiment=mixture --approach=dwa --weight_init="kaiming:xavier" --lamb_loss=[0.1,0.01] --seed=0
python3 run.py --name="lam10-001" --experiment=mixture --approach=dwa --weight_init="kaiming:xavier" --lamb_loss=[10,0.01] --seed=0
python3 run.py --name="lam1" --experiment=mixture --approach=dwa --weight_init="kaiming:xavier" --lamb_loss=1 --seed=0
python3 run.py --name="lam10-1" --experiment=mixture --approach=dwa --weight_init="kaiming:xavier" --lamb_loss=[10,1] --seed=0
python3 run.py --name="lam100-01" --experiment=mixture --approach=dwa --weight_init="kaiming:xavier" --lamb_loss=[100,0.1] --seed=0
