...
class Net(torch.nn.Module):
    '''AlexNet using dynamic weight allocation to retain information over sequentially learned tasks.
    
    Args:
        inputsize (list): general input size for all tasks in channels first mode (default: 3x32x32)
        taskcla (list): list of classes for all tasks in the sequence
    '''
    ...
    def __init__(self, inputsize, taskcla):
        ...
        # functional API - define the layers one by one
        # note: s stores the current output dimension of the image (assuming quadratic)
