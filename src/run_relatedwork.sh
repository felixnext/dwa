...
python3 run.py --name="lam500" --experiment=mixture --approach=ewc --weight_init="kaiming:xavier" --lamb=500 --seed=0
python3 run.py --name="lam5000" --experiment=mixture --approach=ewc --weight_init="kaiming:xavier" --lamb=5000 --seed=0
python3 run.py --name="lam50000" --experiment=mixture --approach=ewc --weight_init="kaiming:xavier" --lamb=50000 --seed=0
python3 run.py --name="curric" --experiment=mixture --approach=ewc --weight_init="kaiming:xavier" --lamb=5000 --curriculum="linear:100:0.2" --seed=0
# SGD
